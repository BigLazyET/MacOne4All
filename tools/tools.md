...
- [官方地址](https://github.com/ghostty-org/ghostty)
- [下载地址](https://ghostty.org/download)

### 3. Termora - 跨平台的终端模拟器和 SSH 客户端
...
- [官方地址](https://github.com/iina/iina)
- [下载地址](https://github.com/iina/iina/releases)

### 5. ABDownloadManager - 一个能加快下载速度的下载管理器
...
使用苹果键盘键或自定义快捷键。显示的是原生macOS的OSD。
...
- [官方地址](https://github.com/obsproject/obs-studio)
- [下载地址](https://github.com/obsproject/obs-studio/releases)

### 10. QuickRecorder - 基于 ScreenCapture Kit 的轻量化多功能 macOS 录屏工具
